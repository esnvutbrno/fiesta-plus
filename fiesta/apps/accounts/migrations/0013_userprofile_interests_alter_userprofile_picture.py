...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0012_userprofile_phone_number'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='userprofile',
            name='picture',
            field=models.ImageField(blank=True, null=True, storage=apps.files.storage.NamespacedFilesStorage('profile-picture', has_permission=apps.accounts.models.profile.has_permission_for_profile_picture_view), upload_to=apps.files.storage.NamespacedFilesStorage.upload_to, verbose_name='profile picture'),
        ),
    ]

...
def as_label(bf: BoundField):
    ...
    return bf.label_tag(attrs={"class": f"Forms__label " f"Forms__label--{input_type} "})
...
def get_form_classes(form: BaseForm | BaseModelForm):
    ...
    return f"Forms__form " f"Forms__form--{base_form_class_name} " f"Forms__form--{form.__class__.__name__.lower()} "

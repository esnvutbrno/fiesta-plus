...
from .views.editor import (
    BuddyRequestEditorDetailView,
    BuddyRequestsEditorView,
    QuickBuddyMatchView,
    UpdateBuddyRequestStateView,
)
...
urlpatterns = [
    ...
    path("update-request-state/<uuid:pk>", UpdateBuddyRequestStateView.as_view(), name="update-request-state"),

            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default="default",
                        max_length=64,
                        verbose_name="human readable name used for recognizing.",
                    ),
                ),
            ],
            options={
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("enabled", "enabled"),
                            ("read_only", "read-only"),
                            ("privileged_only", "privileged users only"),
                            ("disabled", "disabled"),
                        ],
                        default="enabled",
                        help_text="Current state of plugin - affects, if plugin could be displayed by international/member/editor/admin/at all.",
                        max_length=16,
